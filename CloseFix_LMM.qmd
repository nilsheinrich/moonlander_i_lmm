...
```
We see significance only for **N_visible_drift_tiles**. Input noise, N_visible_obstacles, and the interaction effect don't seem to significanty affect the fixation duration in close fixations.
