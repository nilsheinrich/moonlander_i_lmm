...
```
We see significance only for **N_visible_drift_tiles**. Input noise, N_visible_obstacles, and the interaction effect don't seem to significanty affect the fixation duration in resting fixations.
...
draw(plt; figure=(;supertitle="Parametric bootstrap β estimates of variance components"))
```
Of the fixed effects included in our model, only **N_visible_drift_tiles** significantly influences (increases) the fixation duration in resting fixations.
