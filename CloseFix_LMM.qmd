...
draw(plt; figure=(;supertitle="Parametric bootstrap β estimates of variance components"))
```
Of the fixed effects included in our model, **N_visible_drift_tiles** significantly influences (increases) the fixation duration in resting fixations while the significant **interaction** term tells us that the effect of **N_visible_drift_tiles** depends on **N_visible_obstacles**.
...
We detect significant effects for **N_visible_obstacles** , **N_visible_drift_tiles** individually but also for their interaction effect (both **negatively** influencing the effect of the other). **input noise: strong** (in comparison to input_noise: weak) also significantly influences (decreases) fixation location in resting fixations.
