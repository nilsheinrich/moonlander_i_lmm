...
```
Referring to BIC, the model without the interaction term wins. We will therefore proceed with that one.
...
We see significance only for the **N_visible_obstacles**, meaning this covariate significantly influences saccade amplitude in progressive saccades.
