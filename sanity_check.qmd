...
X = [
     1.0, # intercept
     0.0, # level_difficulty: hard
     1.0, # level_difficulty: medium
     1.0, # drift 
     0.0, # input_noise: weak-none 
     1.0, # input_noise: strong-none 
     0.0, # level_difficulty: hard & drift
     1.0  # level_difficulty: medium & drift
     ]
