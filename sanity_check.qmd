...
- N_visible_obstacles (β=0.0343896, σ=0.0113504, p<0.0024)
- N_visible_drift_tiles (β=0.234152, σ=0.0837892, p=0.0052)
with both covariates **increasing** the probability to initiate a distant fixation. 

Both covariates are negatively correlated:
- N_visible_obstacles * N_visible_drift_tiles (β=-0.0736978, σ=0.0145409, p<0.001)
