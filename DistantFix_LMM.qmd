...
```
The model without interaction wins out slightly when referring to BIC (not AIC though). Proceeding with m_varyingSlope_complex_ni.
...
confint(samples)
```
Only **N_visible_obstacles** is significant.
