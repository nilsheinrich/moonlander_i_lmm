...
m_varyingSlope_complex = let
    varSlop = @formula(log(saccade_amplitude) ~ 1 + N_visible_obstacles * N_visible_drift_tiles + input_noise 
...
────────────────────────────────────────────────────────────────────────────────
(Intercept)                            0.177437     0.0804035    2.21    0.0273
N_visible_obstacles                   -0.0566637    0.00975116  -5.81    <1e-08
N_visible_drift_tiles                  0.0116296    0.0603481    0.19    0.8472
input_noise: weak-none                -0.0436339    0.0551966   -0.79    0.4292
input_noise: strong-weak              -0.000215033  0.0579392   -0.00    0.9970
N_visible_obstacles & N_visible_drift_tiles   
                                       0.0161332    0.00788898   2.05    0.0409
────────────────────────────────────────────────────────────────────────────────
...
m_varyingSlope_complex_zc = let
    varSlop = @formula(saccLandSite_dist_to_spaceship ~ 1 + N_visible_obstacles * N_visible_drift_tiles + input_noise 
    + zerocorr(1 + N_visible_obstacles + N_visible_drift_tiles + input_noise | ID));
    fit(MixedModel, varSlop, my_data; contrasts=my_cake);
  end
...
────────────────────────────────────────────────────────────────────────────────
                                         Coef.      Std. Error    z    Pr(>|z|)
────────────────────────────────────────────────────────────────────────────────
(Intercept)                             16.9084      1.09129    15.49    <1e-53
N_visible_obstacles                     -0.428286    0.0900455  -4.76    <1e-05
N_visible_drift_tiles                   -2.404       0.900807   -2.67    0.0076
input_noise: weak-none                   0.106195    2.15442     0.05    0.9607
input_noise: strong-weak                 0.433882    1.57754     0.28    0.7833
N_visible_obstacles & N_visible_drift_tiles  
                                        -0.0499262   0.0768327  -0.65    0.5158
────────────────────────────────────────────────────────────────────────────────

95% CIs:
β1  │ 14.8554    19.0678
β2  │ -0.606689  -0.256518
β3  │ -4.15475   -0.645138
β4  │ -4.08684   4.33581
β5  │ -2.78923   3.48346
β6  │ -0.204915  0.097568
