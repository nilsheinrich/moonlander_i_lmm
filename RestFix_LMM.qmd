...
draw(plt; figure=(;supertitle="Parametric bootstrap β estimates of variance components"))
```
Of the fixed effects included in our model, only N_visible_drift_tiles significantly influences the fixation duration in resting fixations.
...
We detect significant effects for **N_visible_obstacles** , **N_visible_drift_tiles** individually but not for their interaction effect. **input noise: strong** (in comparison to input_noise: weak) also significantly influences fixation location in resting fixations.
